...
namespace awprojectintegrationtests
{
    public class TestContactsData
    {
        DbContextOptions<AwProjectDbContext> _options;
        ...
        {
            _options = new DbContextOptionsBuilder<AwProjectDbContext>()
                            .UseInMemoryDatabase(databaseName: "AwProjectContactsTests")
                            .Options;
        }

        public void BuildDefaults()
        {
            using (var context = new AwProjectDbContext(_options))
            {
        ...
        [Theory]
        [InlineData(FIRST_NAME_1, LAST_NAME_1, EMAIL_1, USERID1, 2, 2)]
        [InlineData(FIRST_NAME_2, LAST_NAME_2, EMAIL_2, USERID1, 1, 2)]
        [InlineData(FIRST_NAME_3, LAST_NAME_3, EMAIL_3, USERID2, 4, 2)]
        [InlineData(FIRST_NAME_4, LAST_NAME_4, EMAIL_4, USERID2, 3, 2)]
