...
namespace awprojectmodels
{
    public class Contact
    {
        ...
        [StringLength(AwProjectConstants.MAX_FIRST_NAME_LENGTH)]
        public string FirstName { get; set; }
        [Display(Name = "Last Name")]
        [Required(ErrorMessage = "Last Name is required")]
        [StringLength(AwProjectConstants.MAX_LAST_NAME_LENGTH)]
        public string LastName { get; set; }
        [Display(Name = "Email Address")]
        [Required(ErrorMessage = "Email Address is required")]
        [StringLength(AwProjectConstants.MAX_EMAIL_LENGTH)]
        [EmailAddress(ErrorMessage = "Invalid Email Address")]
        public string Email { get; set; }
        [Display(Name = "Mobile Phone")]
        [Required(ErrorMessage = "Phone is required")]
        [StringLength(AwProjectConstants.MAX_PHONE_LENGTH)]
        ...
        [StringLength(AwProjectConstants.MAX_STREET_ADDRESS_LENGTH)]
        public string StreetAddress1 { get; set; }
        [Display(Name = "Street Address Line 2")]
        [StringLength(AwProjectConstants.MAX_STREET_ADDRESS_LENGTH)]
        public string StreetAddress2 { get; set; }
        [Required(ErrorMessage = "City is required")]
        [StringLength(AwProjectConstants.MAX_CITY_LENGTH)]
        public string City { get; set; }
        [Required(ErrorMessage = "Zip Code is required")]
        [Display(Name = "Zip Code")]
        [StringLength(AwProjectConstants.MAX_ZIP_CODE_LENGTH, MinimumLength = AwProjectConstants.MIN_ZIP_CODE_LENGTH)]
